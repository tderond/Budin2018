...
python ETCsimulation.py --calculate_average_distribution --lengthscale 2.5 --number_of_goals 37 --spawn_tethered --diffusion_coefficient 0.1 --kcats 1611 1676 --goal_radius 0.017888543819998 --particles 50000 --goal_slowdown 7.4 --timestep_length 0.0005 --num_timesteps 1000 --name NADH_20_tethered --verbose --plot_all_frames imageoutputfile --tethering 0.02 0.5 > distributionoutputfile
